<?php /* Smarty version 2.6.12, created on 2015-06-15 10:35:30
    ...
    <tr>
        <td>
            <table class="tabela-mostra-dados"  cellspacing="2" cellpadding="5" border="0">
                <tr class="no-hover">
                    <td><p class="texto">PRODUTO</p></td>
                </tr>
                <tr style="background-color:#D5DDE3" height="20">
                    <td class="texto-consulta"><strong>Título</strong></td>
                    <td class="texto-consulta"><strong>Produto</strong></td>
                    <td class="texto-consulta"><strong>Segmento</strong></td>
...
?>
                <tr>
                    ...
                    <td class="texto-consulta"><?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['tipo']; ?>
</td>
                    <td class="texto-consulta"><?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['segmento']; ?>
</td>
                    <td class="texto-consulta"><?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['idiomaFormat']; ?>
</td>
                    <td class="texto-consulta" nowrap="nowrap">< <a href="?acao=editar&idAdm=<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['id']; ?>
