<?php /* Smarty version 2.6.12, created on 2016-02-10 14:59:11
         compiled from admin/historico/relacao.html */ ?>
...
?>
                    <a class="<?php if ($this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']] == $_GET['p']): ?> link-pag-ativo <?php endif; ?>" href="adm_historico.php?acao=pesquisar&p=<?php echo $this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']]; ?>
"><?php echo $this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']]; ?>
            ...
            <br>
            <table class="table">
                <h1 class="titulo-pag">Visualizar Histórico</h1>
                <thead>
                    <tr class="cor-tr-btn">
                        <th>Tipo</th>
...
?>
                        <tr class="hover-tr">
                            ...
                            <td class="hidden-xs-down"><?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['data_formatada']; ?>
</td>
                            <td><?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['nomeUsuario']; ?>
</td>
                            <td>
                                ...
                                <div class="select-acoes mg-lf-80">
                                    <?php if ($this->_tpl_vars['menuPesUsuario']): ?>
                                        <a class="cor-tr-btn btn-acoes" href="?acao=visualizar&tpHist=<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['tipoSigla']; ?>
&idCliente=<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['idcliente']; ?>
">visualizar</a> 
                                    <?php endif; ?>
