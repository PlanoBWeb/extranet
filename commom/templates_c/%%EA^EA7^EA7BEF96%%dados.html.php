<?php /* Smarty version 2.6.12, created on 2015-06-15 11:16:29
...
" />
        ...
        <p class="texto">Cadastro produto</p>
...
" class="formu" />
        ...
        <select name="segmento" class="formu">
        	<?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['dadosSegmento']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
            	<option value="<?php echo $this->_tpl_vars['dadosSegmento'][$this->_sections['i']['index']]['id']; ?>
" <?php if ($this->_tpl_vars['dados'][0]['idSegmento'] == $this->_tpl_vars['dadosTipo'][$this->_sections['i']['index']]['id']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['dadosSegmento'][$this->_sections['i']['index']]['titulo']; ?>
</option>
            <?php endfor; endif; ?>
        </select>
...
" <?php if ($this->_tpl_vars['dados'][0]['produtoTipo'] == $this->_tpl_vars['dadosTipo'][$this->_sections['i']['index']]['id']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['dadosTipo'][$this->_sections['i']['index']]['titulo']; ?>
</option>
            <?php endfor; endif; ?>
        </select>
