<?php /* Smarty version 2.6.12, created on 2016-02-10 15:07:32
         compiled from admin/cliente/ver.html */ ?>
 ...
 ?>
	...
	<div class="container">
		<form class="form-ver">
            ...
            <h1 class="titulo-pag">Visualizar Cliente</h1>
            
			<label><strong>Tipo cliente:</strong></label>
            <input type="text" disabled value="<?php echo $this->_tpl_vars['dados'][0]['status']; ?>
">    
...
">	
            ...
            <input type="text" disabled value="<?php echo $this->_tpl_vars['dados'][0]['razao']; ?>
">    
...
"> 
            ...
            <label><strong>Mapa:</strong></label>
            <div class="campo-link-input"><a href="<?php echo $this->_tpl_vars['dados'][0]['mapa']; ?>
" target="_blank"><?php echo $this->_tpl_vars['dados'][0]['mapa']; ?>
</a></div>
...
">	
            ...
            <div class="bt-acoes-interna">
                <?php if ($this->_tpl_vars['menuEdiUsuario']): ?>
                    <a class="btn-form" href="adm_cliente.php?acao=editar&id=<?php echo $this->_tpl_vars['dados'][0]['id']; ?>
">editar</a> 
                <?php endif; ?>
...
, 'cliente')">excluir</a>
		...
		<!-- Contato --><br><br>
            <h1 class="titulo-pag">Visualizar contato do cliente</h1>
            <table class="table">
                <thead>
                    <tr class="cor-tr-btn">
                        <th>Nome</th>
                            ...
                            <td>
                                ...
                                <div class="select-acoes mg-lf-80">
                                    <?php if ($this->_tpl_vars['menuPesUsuario']): ?>
                                        <!-- <a class="cor-tr-btn btn-acoes" href="adm_contato.php?acao=visualizar&id=<?php echo $this->_tpl_vars['dados'][0]['id']; ?>
&idContato=<?php echo $this->_tpl_vars['dadosContato'][$this->_sections['i']['index']]['id']; ?>
"> -->
...
, 'contato')">excluir</a>
        ...
        <?php if ($this->_tpl_vars['dadosAnotacao']): ?> 
        <!-- Contato -->
            <br><br>
            <h1 class="titulo-pag">Visualizar anotação do cliente</h1>
            <table class="table">
                <thead>
                    <tr class="cor-tr-btn">
                        <th>Titulo</th>
                ...
                <tbody>
                    <?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['dadosAnotacao']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
$this->_sections['i']['max'] = $this->_sections['i']['loop'];
$this->_sections['i']['step'] = 1;
$this->_sections['i']['start'] = $this->_sections['i']['step'] > 0 ? 0 : $this->_sections['i']['loop']-1;
...
?>
                        <tr class="hover-tr">
                            <td><a href="adm_anotacao.php?acao=visualizar&id=<?php echo $this->_tpl_vars['dadosAnotacao'][$this->_sections['i']['index']]['id']; ?>
"><?php echo $this->_tpl_vars['dadosAnotacao'][$this->_sections['i']['index']]['titulo']; ?>
</a></td>
                            <td><?php echo $this->_tpl_vars['dadosAnotacao'][$this->_sections['i']['index']]['nome']; ?>
</td>
                            <td>
                                <?php if ($this->_tpl_vars['menuPesUsuario']): ?>
                                    <!-- <a class="cor-tr-btn btn-acoes" href="adm_anotacao.php?acao=visualizar&id=<?php echo $this->_tpl_vars['dados'][0]['id']; ?>
&idAnotacao=<?php echo $this->_tpl_vars['dadosAnotacao'][$this->_sections['i']['index']]['id']; ?>
"> -->
                                    <a class="cor-tr-btn btn-acoes" href="adm_anotacao.php?acao=visualizar&id=<?php echo $this->_tpl_vars['dadosAnotacao'][$this->_sections['i']['index']]['id']; ?>
">
                                    visualizar</a> 
                                <?php endif; ?>
                            </td>
        ...
        <?php endif; ?>
        <br>
		<a href="adm_cliente.php?acao=pesquisar" class="btn-form" ><< voltar</a>
