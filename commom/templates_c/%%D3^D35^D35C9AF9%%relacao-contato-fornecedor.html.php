<?php /* Smarty version 2.6.12, created on 2016-02-10 15:17:40
         compiled from admin/fornecedor/relacao-contato-fornecedor.html */ ?>
            ...
            <table class="table">
                ...
                <thead>
                    <tr class="cor-tr-btn">
                        ...
                        <th class="hidden-xs-down">Cel</th>
                        <th>Opções</th>
                    </tr>
                </thead>
                <tbody>
...
" target="_blank"><?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['email']; ?>
</a></td>
                            <td class="hidden-xs-down"><a href="tel:<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['dddcel'];  echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['celular']; ?>
">(<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['dddcel']; ?>
) <?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['celular']; ?>
</a></td>
                            <td>
                                ...
                                <div class="select-acoes mg-lf-80">
                                    <?php if ($this->_tpl_vars['menuPesUsuario']): ?>
                                        <a class="cor-tr-btn btn-acoes" href="adm_contato_fornecedor.php?acao=visualizar&id=<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['id']; ?>
">visualizar</a> 
                                    <?php endif; ?>
                                    <?php if ($this->_tpl_vars['menuEdiUsuario']): ?>
                                        <a class="cor-tr-btn btn-acoes" href="adm_contato_fornecedor.php?acao=editar&id=<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['id']; ?>
">editar</a> 
                                    <?php endif; ?>
