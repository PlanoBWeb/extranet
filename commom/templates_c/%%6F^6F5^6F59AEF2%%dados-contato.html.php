<?php /* Smarty version 2.6.12, created on 2016-02-05 15:42:55
         compiled from admin/cliente/dados-contato.html */ ?>
...
" />
	    ...
	    <h1 class="titulo-pag">Contato</h1> 
...
" <?php if ($this->_tpl_vars['dadosCliente'][$this->_sections['i']['index']]['id'] == $this->_tpl_vars['idCliente']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['dadosCliente'][$this->_sections['i']['index']]['empresa']; ?>
</option>
            <?php endfor; endif; ?>
        </select>
...
" />
	    ...
	    <label>Cargo:</label>
	    <input type="text" name="cargo" value="<?php echo $this->_tpl_vars['dados'][0]['cargo']; ?>
" />
...
" />
	    ...
	    <input type="text" name="emailPessoal" value="<?php echo $this->_tpl_vars['dados'][0]['emailPessoal']; ?>
" />

	    <label>Skype:</label>
	    <input type="text" name="skype" value="<?php echo $this->_tpl_vars['dados'][0]['skype']; ?>
" />

	    <label>Aniversário:</label>
	    <input type="date" name="aniversario" value="<?php echo $this->_tpl_vars['dados'][0]['aniversario']; ?>
" />
