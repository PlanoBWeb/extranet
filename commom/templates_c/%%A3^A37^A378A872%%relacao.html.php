<?php /* Smarty version 2.6.12, created on 2015-06-15 11:33:59
         compiled from admin/destaque/relacao.html */ ?>
        ...
        <td>
            <table class="tabela-mostra-dados" cellspacing="2" cellpadding="5" border="0">
                ...
                <tr style="background-color:#D5DDE3" height="20">
                    ...
                    <td class="texto-consulta"><strong>Imagem</strong></td>
...
?>
                <tr>
                    ...
                    <td class="texto-consulta"><img src="<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['caminhoImagem']; ?>
" width="100" /></td>
