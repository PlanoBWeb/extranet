<?php /* Smarty version 2.6.12, created on 2015-06-15 11:25:39
         compiled from admin/dica/relacao.html */ ?>
...
<table cellspacing="0" cellpadding="0" border="0" width="93%" align="center" bgcolor="#FFFFFF">
    <tr>
        <td>
            <table class="tabela-mostra-dados" cellspacing="2" cellpadding="5" border="0" width="100%">
                <tr class="no-hover">
                    <td><p class="texto">DICAS</p></td>
                </tr>
                <tr >
