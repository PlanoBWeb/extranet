<?php /* Smarty version 2.6.12, created on 2015-09-14 17:52:15
...
"><?php echo $this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']]; ?>
            ...
            <table class="table">
                ...
                <thead>
                    <tr class="cor-tr-btn">
                        <th>Nome</th>
                        <th class="hidden-xs-down">Perfil</th>
                        <th>Opções</th>
                    </tr>
                </thead>
                <tbody>
...
?>
                        <tr class="hover-tr">
                            ...
                            <td class="hidden-xs-down"><?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['perfilCompleto']; ?>
</td>
                            <td>
