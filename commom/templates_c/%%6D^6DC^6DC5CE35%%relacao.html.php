<?php /* Smarty version 2.6.12, created on 2015-06-15 11:24:42
         compiled from admin/material/relacao.html */ ?>
    ...
    <tr>
        <td>
            <table class="tabela-mostra-dados" cellspacing="2" cellpadding="5" border="0">
                <tr class="no-hover">
                    <td><p class="texto">DISTRIBUIDOR - MATERIAL</p></td>
                </tr>
...
?>
                <tr>
                    ...
                    <!-- <td class="texto"><a href="<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['caminhoImagem']; ?>
" target="_blank"><img src="commom/img/<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['tipoIco']; ?>
" border="0"/></a></td> -->
